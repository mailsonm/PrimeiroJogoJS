// Variáveis para recursos visuais e de áudio do jogo
let imagemCenario;
...
// Variáveis de controle e fluxo do jogo
let jogo;
let fita;
let cenaAtual = 'telaInicial'; // Estado inicial do jogo
let cenas;
let telaInicial;
let botaoGerenciador;
let vida;

// Variáveis para objetos do jogo
let cenario;
let personagem;
let inimigo;
let inimigoGrande;
...
// Matriz para animação do inimigo comum
const matrizInimigo = [
...
// Matriz para animação da personagem principal
...
// Matriz para animação do inimigo grande
...
// Matriz para animação do inimigo voador
...
// Array para armazenar instâncias de inimigos
const inimigos = [];